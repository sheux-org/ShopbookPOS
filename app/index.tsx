...
export default function EntryRoute() {
  ...
  const handleRegister = () => {
    ...
    setTimeout(() => {
      setIsLoading(false);
      cartState.register(businessName, businessAddress, phone);
          ...
          <View style={styles.card}>
            ...
            <View style={styles.formGroup}>
              ...
              <TextInput
                ...
                placeholder="e.g. Shopbook Colombo Store"
                placeholderTextColor="#9CA3AF"
                value={businessName}
            ...
            <TouchableOpacity
              style={[styles.submitButton, (!businessName.trim() || !businessAddress.trim()) && styles.submitButtonDisabled]}
              activeOpacity={0.8}
              onPress={handleRegister}
              disabled={!businessName.trim() || !businessAddress.trim() || isLoading}
            >
              {isLoading ? (
                <ActivityIndicator color={TOKENS.card} size="small" />
              ) : (
