...
export function ForceUpdateScreen({ onRetry, config, currentVersion }: ForceUpdateScreenProps) {
  ...
  return (
    <LinearGradient colors={['#0A0F24', '#121E42', '#1D1135']} style={styles.container}>
      ...
      <Animated.View style={[styles.cardContainer, animatedContainerStyle]}>
        ...
        <View style={styles.versionDetailsContainer}>
          ...
          <View style={[styles.versionBadge, styles.versionBadgeRequired]}>
            <Text style={[styles.versionBadgeTitle, styles.versionBadgeRequiredTitle]}>
              Required
            </Text>
            <Text style={styles.versionBadgeText}>{config ? config.min_version : 'Latest'}</Text>
          </View>
        </View>
        ...
        <TouchableOpacity style={styles.retryButton} onPress={handleRetryPress} activeOpacity={0.7}>
...
const styles = StyleSheet.create({
  ...
  cardContainer: {
    ...
    paddingHorizontal: 24,
    alignItems: 'center',
    boxShadow: '0px 12px 16px 0px rgba(0, 0, 0, 0.5)',
  },
  iconContainer: {
    marginBottom: 24,
    boxShadow: '0px 8px 12px 0px rgba(59, 130, 246, 0.4)',
  },
  iconGradient: {
    width: 72,
    height: 72,
  ...
  updateButton: {
    ...
    overflow: 'hidden',
    marginBottom: 16,
    boxShadow: '0px 4px 8px 0px rgba(37, 99, 235, 0.3)',
  },
