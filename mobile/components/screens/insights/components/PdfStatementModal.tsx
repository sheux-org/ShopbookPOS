...
export const PdfStatementModal: React.FC<PdfStatementModalProps> = ({
  visible,
  onClose,
  selectedReportType,
  onSelectReportType,
        ...
        >
          ...
          <View style={styles.premiumModalHeader}>
            <View style={styles.pdfModalTitleRow}>
              ...
              <Text style={styles.pdfModalTitle}>{t('insights.pdfModalTitle')}</Text>
            </View>
            <Text style={styles.pdfModalDescription}>{t('insights.pdfModalDesc')}</Text>
          </View>
          ...
          <View style={styles.premiumModalFooter}>
            ...
            >
              ...
              <Text style={styles.pdfGenerateBtnText}>{t('insights.generatePdfBtn')}</Text>
            </TouchableOpacity>
