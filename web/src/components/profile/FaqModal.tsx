  ...
  return (
    <div className="modal-overlay">
      <div className="modal-content" style={{ maxWidth: '560px' }}>
        ...
        <div className="modal-body" style={{ maxHeight: '480px', overflowY: 'auto', padding: '16px 20px' }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
            {FAQS.map((faq, index) => {
              const isExpanded = expandedFaqIndex === index;
              return (
                <div key={index} className="faq-item-container" style={{ borderBottom: '1px solid var(--border)', paddingBottom: '4px' }}>
                  <button
                  ...
                  {isExpanded && (
                    ...
                    >
                      <p className="faq-answer-text" style={{ margin: 0 }}>{faq.a}</p>
                    </div>
                  )}
                </div>
              );
